...
import { Sparkles, Rocket, Crown, AtSign, TrendingUp, TrendingDown, Brain, Zap } from 'lucide-react';
...
export const NFT3DCard: React.FC<NFT3DCardProps> = ({ agent, userName, nftNumber, minterTwitter, onDeployNow }) => {
  ...
  return (
    <div className="relative w-full max-w-[340px] mx-auto perspective-1000">
      ...
      {/* 3D卡片容器 */}
      <div
        className={`relative transition-all duration-1000 ease-out transform-style-3d ${
          isFlipped ? 'rotate-y-360' : 'rotate-y-0'
        }`}
        style={{
