...
export const MintingLoader: React.FC<MintingLoaderProps> = ({ onComplete, agentName }) => {
  ...
  return (
    <div className="relative w-full h-full flex flex-col p-4">
      ...
      <div className="relative z-10 mb-4">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#836EF9] to-[#00FF9D] flex items-center justify-center">
      ...
      {/* Steps List - Compact */}
      <div className="relative z-10 flex-1 bg-[#0a0b14] border border-slate-800 rounded-lg overflow-hidden flex flex-col min-h-0">
        ...
        >
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {isActive && (
                    <div className="text-[9px] font-mono text-[#836EF9] truncate">
                      {step.code}
                    </div>
                  )}
                </div>
          ...
          {/* Complete Message */}
          {isComplete && (
            <div className="flex items-center gap-2 p-2 text-[#00FF9D] animate-fade-in">
      ...
      {/* Terminal - Current Step Detail */}
      <div className="relative z-10 mt-3 bg-[#0a0b14] border border-slate-800 rounded-lg overflow-hidden shrink-0">
        <div className="p-2 border-b border-slate-800 bg-[#0f111a] flex items-center justify-between">
          <div className="flex items-center gap-1.5">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-start gap-1.5">
                ...
                <span className="text-white break-all">
                  {currentCode}
                  <span 
                    className={`inline-block w-1.5 h-3.5 bg-[#00FF9D] ml-0.5 align-middle ${cursorVisible ? 'opacity-100' : 'opacity-0'}`}
                  />
                </span>
              </div>
            </div>
