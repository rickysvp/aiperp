...
export const translations = {
  en: {
    ...
    wallet_total_equity: "Account Equity",
    ...
    wallet_total_wins: "Win Count",
    wallet_total_losses: "Loss Count",
    ...
    wallet_send_mon: "Send MON to this address to deposit",
    ...
    wallet_agents_account: "Agents Account",
    wallet_total_assets: "Total Assets",
    wallet_manual_withdraw: "Manual withdrawal required to reallocate",
    wallet_no_assets: "No assets in Agents",
    wallet_long: "Long",
    wallet_short: "Short",
    wallet_auto: "Auto",
    wallet_no_active_agents: "No active Agents",
    wallet_withdraw_before_reallocate: "Assets must be withdrawn from Agents before they can be reallocated",
    wallet_daily_pnl_title: "Daily PnL",
    wallet_equity: "Equity",
    wallet_pnl: "PnL",
    wallet_performance: "Performance",
    wallet_agent_assets: "Agent Assets",
    wallet_total_allocated: "Deployed Capital",
    ...
    wallet_liquidity: "Liquidity Yield",
    wallet_pnl_chart: "PnL Curve",
    wallet_week: "Week",
    wallet_month: "Month",
    wallet_best: "High",
    wallet_worst: "Low",
    wallet_data_points: "Data Points",
    wallet_no_data: "No Data",
    wallet_start_trading: "Start trading to see chart",
    wallet_trading_stats: "Trading Stats",
    wallet_agent_accounts: "Active Agents",
    wallet_allocated: "Deployed",
    ...
    // removed duplicate keys to avoid conflicts
    ...
    liquidity_apr: "APR",
    liquidity_annual_yield: "Annual Yield",
    liquidity_daily_volume: "Daily Volume",
    liquidity_fee_share: "Fee Share",
    ...
    liquidity_estimated_monthly: "Est. Monthly Earnings",
    liquidity_my_position: "My Position",
    liquidity_staked_amount: "Staked Amount",
    liquidity_pool_share: "Pool Share",
    liquidity_total_earned: "Total Earned",
    liquidity_no_position: "No active position",
    liquidity_start_earning: "Stake MON to start earning",
    liquidity_pending_rewards: "Pending Rewards",
    liquidity_claim_rewards: "Claim Rewards",
    liquidity_how_it_works: "How It Works",
    liquidity_step1: "Stake your MON tokens into the liquidity pool",
    liquidity_step2: "Earn a share of trading fees from agent transactions",
    liquidity_step3: "Claim rewards anytime or compound for higher returns",
    liquidity_info_text: "Rewards are calculated in real-time based on your pool share. No lock-up period required.",
    liquidity_stake_success: "Successfully staked MON!",
    ...
    legal_terms_3_text: "AIperp.fun is a decentralized trading simulation platform. The platform uses USDC for all transactions. Users connect their own non-custodial wallets and maintain full control of their funds. The platform does not custody user assets. All trading is simulated using real USDC deposits, but trading mechanics are gamified.",
  ...
  zh: {
    ...
    disconnect: "断开连接",
    // removed duplicate key in zh block
    realized_pnl: "已实现盈亏",
    active_agents: "活跃特工",
    ...
    wallet_analytics: "分析",
    wallet_referrals: "推荐",
    wallet_total_equity: "账户净值",
    wallet_available: "可用余额",
    wallet_staked_agents: "代理质押",
    ...
    wallet_deposit: "充值",
    wallet_withdraw: "提现",
    wallet_copy_ref: "复制邀请码",
    wallet_copied: "已复制!",
    wallet_portfolio_alloc: "资产配置",
    wallet_no_positions: "无活跃仓位",
    wallet_no_active: "无活跃代理",
    wallet_deploy_hint: "部署代理开始交易",
    wallet_tx_history: "交易记录",
    wallet_all: "全部",
    wallet_daily_pnl: "每日盈亏 (最近7天)",
    wallet_total_wins: "盈利次数",
    wallet_total_losses: "亏损次数",
    wallet_partner_program: "合伙人计划",
    wallet_total_recruits: "邀请人数",
    wallet_your_ref_code: "你的邀请码",
    wallet_share_twitter: "分享到 Twitter",
    wallet_how_it_works: "如何运作",
    wallet_step1_title: "分享你的邀请码",
    wallet_step1_desc: "使用你的专属邀请码邀请好友",
    wallet_step2_title: "他们铸造并交易",
    wallet_step2_desc: "你的邀请人铸造代理并开始交易",
    ...
    wallet_send_mon: "发送 MON 到此地址进行充值",
    ...
    wallet_agents_account: "代理账户",
    wallet_total_assets: "总资产",
    wallet_manual_withdraw: "需要手动撤回才能重新分配",
    wallet_no_assets: "代理账户暂无资产",
    wallet_long: "做多",
    wallet_short: "做空",
    wallet_auto: "自动",
    wallet_no_active_agents: "暂无活跃代理",
    wallet_withdraw_before_reallocate: "资产必须从代理账户撤回后才能重新分配",
    wallet_daily_pnl_title: "每日盈亏",
    wallet_equity: "净值",
    wallet_pnl: "盈亏",
    wallet_performance: "业绩表现",
    wallet_agent_assets: "代理资产",
    wallet_total_allocated: "已部署资金",
    wallet_active: "活跃",
    wallet_inactive: "闲置",
    wallet_direction_allocation: "方向分配",
    wallet_no_transactions: "暂无交易记录",
    wallet_equity_history: "净值历史",
    wallet_title: "钱包",
    wallet_subtitle: "管理您的投资组合",
    wallet_total_balance: "总资产",
    wallet_trading_pnl: "交易盈亏",
    wallet_liquidity: "流动性收益",
    wallet_pnl_chart: "盈亏曲线",
    wallet_week: "周",
    wallet_month: "月",
    wallet_best: "最高",
    wallet_worst: "最低",
    ...
    wallet_agent_accounts: "活跃代理",
    wallet_allocated: "已部署",
    wallet_leverage: "杠杆",
    ...
    // removed duplicate wallet keys (keep only the earlier English keys)
    ...
    liquidity_apr: "年化收益",
    liquidity_annual_yield: "年化收益率",
    liquidity_daily_volume: "日交易量",
    liquidity_fee_share: "手续费分成",
    ...
    liquidity_estimated_monthly: "预估月收益",
    liquidity_my_position: "我的仓位",
    liquidity_staked_amount: "质押金额",
    liquidity_pool_share: "池子份额",
    liquidity_total_earned: "总收益",
    liquidity_no_position: "无活跃仓位",
    liquidity_start_earning: "质押 MON 开始赚取收益",
    liquidity_pending_rewards: "待领取奖励",
    liquidity_claim_rewards: "领取奖励",
    liquidity_how_it_works: "如何运作",
    liquidity_step1: "将 MON 代币质押到流动性池",
    liquidity_step2: "从特工交易手续费中获得分成",
    liquidity_step3: "随时领取奖励或复利获得更高回报",
    liquidity_info_text: "奖励根据您的池子份额实时计算。无需锁定期。",
    liquidity_stake_success: "质押 MON 成功！",
    ...
    legal_terms_3_text: "AIperp.fun 是一个去中心化交易模拟平台。平台使用 USDC 进行所有交易。用户连接自己的非托管钱包并完全控制自己的资金。平台不托管用户资产。所有交易使用真实 USDC 存款进行模拟，但交易机制是游戏化的。",
