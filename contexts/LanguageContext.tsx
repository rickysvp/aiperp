...
export const translations = {
  en: {
    ...
    legal_terms_3_text: "AIperp.fun is a gamified simulation platform. All tokens, including $MON, are virtual in-game points with no monetary value, no real-world utility, and cannot be exchanged for fiat currency or other digital assets. The platform does not custody, manage, or facilitate the trading of any real assets.",
  ...
  zh: {
    ...
    legal_terms_3_text: "AIperp.fun 是一个游戏化模拟平台。所有代币（包括 $MON）都是虚拟游戏积分，没有货币价值、没有现实世界的实用性，不能兑换法定货币或其他数字资产。本平台不托管、管理或促进任何真实资产的交易。",
